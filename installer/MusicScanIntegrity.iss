...
;
; Built from the finished portable build: dotnet publish fills artifacts\publish
; (see README), then this script wraps it. The installed and portable versions
; are therefore the same files.
;
